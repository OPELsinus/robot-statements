    ...
    if cur_day_type != 'Holiday':
        ...
        for ind, yesterday in enumerate(weekends):
            ...
            if weekends_type[ind] != 'Holiday' and df2 is not None and yesterdays_reestr_date is not None:
                df1 = odines(yesterday)  # correct with yesterdays_reestr_date
        ...
        # send_message_by_smtp(smtp_host, to=['Abdykarim.D@magnum.kz', 'Mukhtarova@magnum.kz', 'Goremykin@magnum.kz', 'Ibragimova@magnum.kz'], subject='Сверка выписок ROBOT', body='Сверка выписок завершилась', username=smtp_author)
